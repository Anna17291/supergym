...
var _initSwiper = require("./modules/init-swiper");
var _openCloseProducts = require("./modules/open-close-products");
var _playVideo = require("./modules/play-video");
(0, _initSwiper.initSwiper)();
(0, _initSwiper.initSwiperFeedback)();
(0, _openCloseProducts.openCloseProducts)();
...
},{"./modules/form-validate/form":3,"./modules/init-swiper":9,"./modules/open-close-products":10,"./modules/play-video":11,"./utils/ios-vh-fix":13}],2:[function(require,module,exports){
"use strict";
...
exports.initSwiperFeedback = exports.initSwiper = void 0;
var _swiper = _interopRequireDefault(require("../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var initSwiper = function initSwiper() {
  var coachSwiper = new _swiper.default('.coachs-slider', {
...
var initSwiperFeedback = function initSwiperFeedback() {
  var feedbackSwiper = new _swiper.default('.feedback-slider', {
    slidesPerView: 1,
    navigation: {
...
exports.initSwiperFeedback = initSwiperFeedback;

},{"../vendor/swiper":14}],10:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.openCloseProducts = void 0;
var openCloseProducts = function openCloseProducts() {
  var firstList = document.querySelector('.terms-list--1');
  var secondList = document.querySelector('.terms-list--2');
  var thirdList = document.querySelector('.terms-list--3');
  var buttonOne = document.querySelector('.length-item__button--1');
  var buttonTwo = document.querySelector('.length-item__button--2');
  var buttonThree = document.querySelector('.length-item__button--3');
...
exports.openCloseProducts = openCloseProducts;
...
var buttonVideo = document.querySelector('.media-video__button');
var video = document.querySelector('.media-video');
var iframeBlock = video.querySelector('[data-video-container]');
